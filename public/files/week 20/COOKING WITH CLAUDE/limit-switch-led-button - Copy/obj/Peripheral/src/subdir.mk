...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -fmax-errors=20 -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized -g -I"c:/Users/nadec/mounriver-studio-projects/limit-switch-led-button/Debug" -I"c:/Users/nadec/mounriver-studio-projects/limit-switch-led-button/Core" -I"c:/Users/nadec/mounriver-studio-projects/limit-switch-led-button/User" -I"c:/Users/nadec/mounriver-studio-projects/limit-switch-led-button/Peripheral/inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
