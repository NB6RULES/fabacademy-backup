...
<div style="margin-top: 20px;">
  <a href="../../files/student.md" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; border-radius: 4px; font-weight: bold; transition: background-color 0.3s;">View Student Agreement Document</a>
</div>
